...
class MessageControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'message[recipient]' => 'Testing',
            'message[groupement]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setGroupement('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'message[recipient]' => 'Something New',
            'message[groupement]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getGroupement());
    }
